import{_ as a,c as n,a0 as p,o as i}from"./chunks/framework.Cde5lyPc.js";const e="/gaius-blog/assets/directory.EZDVDzKE.png",u=JSON.parse('{"title":"","description":"","frontmatter":{},"headers":[],"relativePath":"project/gaius-admin/setup.md","filePath":"project/gaius-admin/setup.md"}'),l={name:"project/gaius-admin/setup.md"};function t(c,s,o,d,h,r){return i(),n("div",null,s[0]||(s[0]=[p(`<h4 id="详细目录结构" tabindex="-1">详细目录结构 <a class="header-anchor" href="#详细目录结构" aria-label="Permalink to &quot;详细目录结构&quot;">​</a></h4><div class="language- vp-adaptive-theme"><button title="Copy Code" class="copy"></button><span class="lang"></span><pre class="shiki shiki-themes github-light github-dark vp-code" tabindex="0"><code><span class="line"><span>gaius-admin/</span></span>
